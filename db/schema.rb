...
ActiveRecord::Schema[8.1].define(version: 2026_01_21_162744) do
  ...
  create_table "sankalp_categories", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["name"], name: "index_sankalp_categories_on_name", unique: true
    t.index ["user_id"], name: "index_sankalp_categories_on_user_id"
  end

  create_table "sankalp_users", force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_sankalp_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_sankalp_users_on_reset_password_token", unique: true
  end
